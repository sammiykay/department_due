"""
Django settings for DepartmentalDues project.
...
SECRET_KEY = 'django-insecure-e)$l%do!^i#z(hm%v(kntwutrs-#+(50rmfmybc7@zrk_1#gb5'
...
ROOT_URLCONF = 'DepartmentalDues.urls'
...
WSGI_APPLICATION = 'DepartmentalDues.wsgi.application'
