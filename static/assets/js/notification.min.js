function showNotification(status, main_message, submessage) {
                ...
                <div class="p-4">
                  <div class="flex items-start">
                    ...
                    <div class="ml-3 w-0 flex-1 pt-0.5">
                      <p class="text-sm font-medium text-gray-900">${main_message}!</p>
        ...
        <div class="flex items-start">
          <div class="flex-shrink-0">
            <svg class="h-6 w-6 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01M12 6.5a9 9 0 110 18 9 9 0 010-18zm0-2.25a9 9 0 00-9 9 9 9 0 009 9 9 9 0 009-9 9 9 0 00-9-9z" />
            </svg>
          </div>
          <div class="ml-3 w-0 flex-1 pt-0.5">
            <p class="text-sm font-medium text-gray-900">${main_message}!</p>
...
// Function to close the notification when the close button is clicked
function closeNotification(button) {
  button.closest('div[aria-live="assertive"]').remove();
}
